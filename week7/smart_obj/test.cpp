...
int test_shared_plus1() {
    ...
    if (a->get() != 11) {
        result = 0;
        string str("plus1: Error is a->get() != 11");
        print_error(str);
    }

    if (b->get() != 7) {
        result = 0;
        string str( "plus1: Error is b->get() != 7");
        print_error(str);
    }

    if (c->get() != 18) {
        result = 0;
        string str( "plus1: Error is c->get() != 18");
        print_error(str);
    }
    return result;
}
...
int test_shared_base2() {
    ...
    shared_ref b = a;
    {
        ...
        if (a.count() != 2) {
            result = 0;
            string str("shared_base2: Error is a.count() != 2");
            print_error(str);
        }
        if (b.count() != 2) {
            result = 0;
        ...
        if (c.get() != nullptr) {
            result = 0;
            string str( "shared_base2: Error is c.get() != nullptr");
            print_error(str);
        }
    }
...
int test_unique_plus1() {
    ...
    if (a.get() != nullptr) {
        result = 0;
        string str( "plus1: Error is a.get() != nullptr");
        print_error(str);
    }

    if (b.get() != nullptr) {
        result = 0;
        string str( "plus1: Error is b.get() != nullptr");
        print_error(str);
    }
...
int test_unique_base() {
    ...
    unique_obj a(new Object(30));
    {
        ...
        if (a->get() != c->get()) {
            result = 0;
            string str( "unique_base: Error is a->get() != c->get()");
            print_error(str);
        }
    }
    return result;
...
int test_unique_base2() {
    int result = 1;
    {
        ...
        if (c.get() != nullptr) {
            result = 0;
            string str( "unique_base2: Error is c.get() != nullptr");
            print_error(str);
        }
        c.release();
        if (c.get() != nullptr) {
