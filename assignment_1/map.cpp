...
int main() {
	...
	m.insert(pair<string, int>("first", 10));
	m.insert(pair<string, int>("second", 20));
	m.insert(pair<string, int>("third", 30));
	m.insert(pair<string, int>("fourth", 40));
    ...
    int m1 = 0; // m에서 key값을 넣어 value를 얻어 채우세요
    int m2 = 0; // m에서 key값을 넣어 value를 얻어 채우세요
    int m3 = 0; // m에서 key값을 넣어 value를 얻어 채우세요
    int m4 = 0; // m에서 key값을 넣어 value를 얻어 채우세요
